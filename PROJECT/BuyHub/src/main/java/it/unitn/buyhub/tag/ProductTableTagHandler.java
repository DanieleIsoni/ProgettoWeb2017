                ...
                for (Product product : products) {
                    ...
                    if (owner) {
                        out.println("<td>\n"
                                ...
                                + "                                </a>\n"
                                + "                                <a href=\"../restricted/productPhoto?id=" + product.getId() + "\" title=\"" + Utility.getLocalizedString(pageContext, "product_photo_title") + "\" class=\"btn btn-secondary a-btn-slide-text mybtn\">\n"
