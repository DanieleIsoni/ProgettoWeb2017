...
public class Utility {
    ...
    /**
     * Use this function to translate a string using the Bundles It's an
     * equivalent of fmt:message JSP tag
     */
    ...
    static public enum CAPABILITY {
        INVALID, USER, SHOP, ADMIN
    };

    /**
     * Function to save a generic file to a given filename inside the
     * uploadedContentFolder
     *
    ...
    /**
     * Function to save a generic file to a random file inside the
     * uploadedContentFolder
     *
     * @param is the InputFileStream to save
    ...
    /**
     * Function to save a picture to a JPEG encoded file, with a random name,
     * inside the uploadedContent folder It should convert automatically other
     * formats to JPEG, but the library have some bug with the alpha channel and
     * sometimes the colors aren't correct. To solve it, save only JPEG images
     *
    ...
    /**
     * Function to save a picture to a JPEG encoded file, with a given name,
     * inside the uploadedContent folder It should convert automatically other
     * formats to JPEG, but the library have some bug with the alpha channel and
     * sometimes the colors aren't correct. To solve it, save only JPEG images
     *
    ...
    public static String saveJPEG(InputStream is, String filename) {
        ...
        try {
            ...
            try (OutputStream os = new FileOutputStream(file)) {
                ...
                Log.error("Error saving image:" + exp.getMessage());
                exp.printStackTrace();
            }
        } catch (IOException ex) {
            Log.error("Error saving file: " + ex.getMessage());
