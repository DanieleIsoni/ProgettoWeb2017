        ...
        try {
            ...
            try {
                ...
                out.println("                    </div>\n"
                        + "                    <!-- control arrows -->\n"
                        + "                    <div class=\"prev\">\n"
                        + "                        <span class=\"glyphicon glyphicon-chevron-left slideshow_arrows\" aria-hidden=\"true\"></span>\n"
                        + "                    </div>\n"
                        + "                    <div class=\"next-car\">\n"
                        + "                        <span class=\"glyphicon glyphicon-chevron-right slideshow_arrows\" aria-hidden=\"true\"></span>\n"
                        + "                    </div>\n"
                        + "\n"
                        + "                </div>\n"
                        + "            </div>\n"
