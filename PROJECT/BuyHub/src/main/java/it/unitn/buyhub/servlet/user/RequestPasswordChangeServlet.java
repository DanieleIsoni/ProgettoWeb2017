...
/**
 *  This servlet is called when a user request password recovery
 *  A link is sent by email, see on the documentation
 *  to learn more on its construction in the user
 *  validation section
 * @author massimo
 */
